"""
This script provides a template for extra figures that are used for understanding the
data, but are not included in the paper.

Replace the comment above with a description of which figure will be plotted by this script.
"""
