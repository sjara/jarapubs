...
for indCell, thisCell in enumerate(exampleCells):
    ...
    plt.suptitle(f'Recording Site:{dbRow.recordingSiteName}\n' + f'VOT-SI ={bestVotIndex}'+ f'FT-SI = {bestFtIndex},', fontsize=20, fontweight='bold', y = 0.99)
    ...
    plt.title(r'$\Delta$VOT, FT=9oct/s', fontsize=20, fontweight='bold')
    ...
    plt.title(r'$\Delta$FT, VOT=0ms', fontsize=20, fontweight='bold')
    ...
    #plt.xlabel('Time (s)')
    plt.ylabel('FT slope (oct/s)', fontsize=20, fontweight='bold')
    plt.title(r'$\Delta$FT, VOT=60ms', fontsize=20, fontweight='bold')
